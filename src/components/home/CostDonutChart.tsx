  ...
  return (
    <Card padding="sm" className="flex flex-col min-h-[180px]" data-testid="home-cost-donut-charts">
      <div className="mb-2 flex items-center justify-between gap-3">
        <div className="text-sm font-semibold text-foreground">花费占比</div>
      </div>
      {loading ? (
        ...
        <div className="grid grid-cols-2 gap-4 flex-1">
          <div className="flex flex-col">
            <div className="text-xs font-medium text-muted-foreground mb-1">供应商</div>
            <div className="h-[140px]">
              <DonutChart data={providerData.data} total={providerData.total} isDark={isDark} />
            </div>
          </div>
          <div className="flex flex-col">
            <div className="text-xs font-medium text-muted-foreground mb-1">模型</div>
            <div className="h-[140px]">
