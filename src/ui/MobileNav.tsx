    ...
    <div className="fixed inset-0 z-50 lg:hidden">
      ...
      >
        <div className="flex h-full flex-col">
          {/* Header */}
          <div className="flex items-center justify-between border-b border-border px-4 pb-4 pt-9">
            <div className="flex items-center gap-3">
              <div className="text-sm font-semibold text-foreground">AIO Coding Hub</div>
              {hasUpdate && (
                <button
                  type="button"
                  className={cn(
...
export function MobileHeader({ onMenuClick }: MobileHeaderProps) {
  ...
  return (
    <header className="sticky top-0 z-30 flex items-center justify-between border-b border-border bg-background/80 px-4 pb-3 pt-9 backdrop-blur lg:hidden">
      ...
      <div
        className={cn(
          ...
          isGatewayRunning ? "bg-emerald-500" : "bg-muted-foreground/40"
        )}
